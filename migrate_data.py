...
def insert_to_tweet_table(dbName: str, df: pd.DataFrame, table_name: str) -> None:
    ...
    for _, row in df.iterrows():
        sqlQuery = f"""INSERT INTO {table_name}(created_at, source, original_text, polarity,
        subjectivity, lang, favorite_count, retweet_count, original_author, followers_count, 
        friends_count, hashtags, user_mentions, place, cleaned_text)  
...
if __name__ == "__main__":
    ...
    # print(df.columns)
    # print(df.info())
    insert_to_tweet_table(dbName='Twitter', df=df,
